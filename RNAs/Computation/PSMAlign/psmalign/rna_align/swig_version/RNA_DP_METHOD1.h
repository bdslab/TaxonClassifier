...
public:
	...
	float DP(RNA_DP_SIZE& dpsize, int stem1_upstream_end, int stem1_downstream_start, int stem2_upstream_end, int stem2_downstream_start);
	float basic_cost(int l1,int r1,int l2,int r2);
	bool basic_cost(RNA_DP_SIZE &dpsize, float *cost, int stem1_upstream_end, int stem1_downstream_start, int stem2_upstream_end,
			int stem2_downstream_start, DEL_QUE *delque1=NULL,DEL_QUE *delque2=NULL);
public:
//	void write_align(ostream &out,int len_per_line);
	vector < vector<string> > write_align(float alignment_cost, int stem1_upstream_end, int stem1_downstream_start, int stem2_upstream_end,
					      int stem2_downstream_start);
	int back_track(RNA_DP_SIZE dpsize, int stem1_upstream_end, int stem1_downstream_start, int stem2_upstream_end,
